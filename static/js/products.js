...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _cart__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cart */ \"./lib/cart.js\");\nvar cart=new _cart__WEBPACK_IMPORTED_MODULE_0__.Cart(_cart__WEBPACK_IMPORTED_MODULE_0__.cartService,_cart__WEBPACK_IMPORTED_MODULE_0__.cartView),productListingEl=document.getElementById(\"products-listing\");Array.from(productListingEl.children).forEach(function(a){var b=a.querySelector(\"button.btn\"),c=new _cart__WEBPACK_IMPORTED_MODULE_0__.CartItem({id:a.dataset.id,title:a.dataset.title,imgUrl:a.dataset.imgurl,price:a.dataset.price});b.addEventListener(\"click\",function(){cart.addItem(c)})});\n\n//# sourceURL=webpack://code-exercise/./lib/products.js?");
